...
func update_blend_position(dir_vector: Vector2) -> void:
	...
	animation_tree.set("parameters/StateMachine/AttackState/blend_position", dir_vector)
	animation_tree.set("parameters/StateMachine/RollState/blend_position", dir_vector)
